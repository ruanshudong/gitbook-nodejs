...
var ViewController = /** @class */ (function () {
    ...
    ViewController.initialize = function () {
        marked_1.default.setOptions({
            renderer: new marked_1.default.Renderer(),
            highlight: function (code, language) {
                var validLanguage = highlight_js_1.default.getLanguage(language) ? language : 'plaintext';
    ...
    ViewController.view = function (ctx) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                content = fs_extra_1.default.readFileSync(path_1.default.join(webConf_1.default.respository.path, subpath)).toString();
