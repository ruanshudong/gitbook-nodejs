...
var TreeController = /** @class */ (function () {
    ...
    TreeController.getToken = function (i) {
        var token = i.tokens[0];
        if (token.tokens && token.tokens[0].type == 'link') {
            return token.tokens[0];
        }
        return token;
    };
    TreeController.parseText = function (i) {
    ...
    TreeController.loadTree = function () {
        ...
        tokens.forEach(function (i) {
            ...
            if (i.type == 'heading') {
                ...
                _this.parseItem(_this._treeData[_this._treeData.length - 1], i.items);
            }
        });
    };
